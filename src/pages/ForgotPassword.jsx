      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            ...
            <button type="submit" className='w-full bg-blue-600 text-white px-7 py-3 text-small font-medium uppercase rounded-md shadow-md hover:bg-blue-700 transition duration-100 ease-in-out hover:shadow-xl active:bg-blue-800'>Send reset email</button>
